$(document).ready(function(){
  ...
  function processResponse(msg, display_user_current_position, user_latitude, user_longitude){
    ...
    _.each(msg, function(place){
      ...
      if((place.parkraumParkart != "")&&(place.parkraumParkart !== undefined)) code += '<li class="red">Parkraumparkart <span class="bold"> <img src="'+ icons[place.parkraumParkart] +'" alt="" />  '+ place.parkraumParkart +'.</span></li>';
      if((place.parkraumEntfernung != "")&&(place.parkraumEntfernung !== undefined)) code += '<li class="red">Befindet sich <span class="bold">'+ place.parkraumEntfernung +' von '+ place.parkraumBahnhofName +'.</span></li>';
      if((place.parkraumZufahrt != "")&&(place.parkraumZufahrt !== undefined)) code += '<li class="red">Straße: <span class="bold">'+ place.parkraumZufahrt +'.</span></li>';
      if((place.parkraumOeffnungszeiten != "")&&(place.parkraumOeffnungszeiten !== undefined)) code += '<li class="red">Öffnungszeiten: <span class="bold">'+ place.parkraumOeffnungszeiten +'.</span></li>';
      if((place.parkraumTechnik != "")&&(place.parkraumTechnik !== undefined)) code += '<li class="red">parkraumTechnik: <span class="bold">'+ place.parkraumTechnik +'.</span></li>';
      if((place.zahlungMedien != "")&&(place.zahlungMedien !== undefined)) code += '<li class="red">zahlungMedien: <span class="bold">'+ place.zahlungMedien +'.</span></li>';
      if((place.tarifParkdauer != "")&&(place.tarifParkdauer !== undefined)) code += '<li class="red">Parkdauer: <span class="bold">'+ place.tarifParkdauer +'.</span></li>';
      if((place.parkraumBetreiber != "")&&(place.parkraumBetreiber !== undefined)) code += '<li class="red">Betreiber: <span class="bold">'+ place.parkraumBetreiber +'.</span></li>';
        code += '</ul></p>';
        ...
        code += '<div class="bs-example table-preise" data-example-id="hoverable-table"> <table class="table table-hover"> <thead> ';
          ...
          if((place.tarif20Min != "")&&(place.tarif20Min !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>20Min.</td> <td>'+ place.tarif20Min +'€</td></tr>';
          if((place.tarif30Min != "")&&(place.tarif30Min !== undefined)) code += ' <tr> <th scope="row">'+ (c++).toString() +'</th> <td>30Min.</td> <td>'+ place.tarif30Min +'€</td></tr>';
          if((place.tarif1Std != "")&&(place.tarif1Std !== undefined)) code += ' <tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Std</td> <td>'+ place.tarif1Std +'€</td></tr>';
          if((place.tarif1Tag != "")&&(place.tarif1Tag !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Tag</td> <td>'+ place.tarif1Tag +'€</td></tr>';
          if((place.tarif1TagRabattDB != "")&&(place.tarif1TagRabattDB !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Tag mit Rabbat der DBBahn</td> <td>'+ place.tarif1TagRabattDB +'€</td></tr>';
          if((place.tarif1Woche != "")&&(place.tarif1Woche !== undefined)) code += ' <tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Woche</td> <td>'+ place.tarif1Woche +'€</td></tr><tr>';
          if((place.tarif1WocheRabattDB != "")&&(place.tarif1WocheRabattDB !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Woche mit Rabbat der DBahn</td> <td>'+ place.tarif1WocheRabattDB +'€</td></tr>';
          if((place.tarif1MonatAutomat != "")&&(place.tarif1MonatAutomat !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Monat (Zahlung am Automat)</td> <td>'+ place.tarif1MonatAutomat +'€</td></tr>';
          if((place.tarif1MonatDauerparken != "")&&(place.tarif1MonatDauerparken !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Monat (Dauerparken)</td> <td>'+ place.tarif1MonatDauerparken +'€</td></tr>';
          if((place.tarif1MonatDauerparkenFesterStellplatz != "")&&(place.tarif1MonatDauerparkenFesterStellplatz !== undefined)) code += '<tr> <th scope="row">'+ (c++).toString() +'</th> <td>1Monat (Festplatz)</td> <td>'+ place.tarif1MonatDauerparkenFesterStellplatz +'€</td></tr>';
